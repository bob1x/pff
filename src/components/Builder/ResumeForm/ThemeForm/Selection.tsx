...
const FontFamilySelections = ({
  ...
  return (
    <SelectionsWrapper>
      {allFontFamilies.map((fontFamily: FontFamily, idx) => {
...
export const FontFamilySelectionsCSR = (
  props: React.ComponentProps<typeof FontFamilySelections>
) => {
  if (typeof window === "undefined") return null;
  return <FontFamilySelections {...props} />;
};
